...
export default function SeoImageOptimization() {
  return (
    <>
      <Helmet>
        <title>
          SEO Image Optimization Guide | CompressIts Blog
        </title>

        <meta
          name="description"
          content="Learn how image optimization improves SEO, website speed, Core Web Vitals, and user experience. Discover the best image formats and image SEO tips with CompressIts."
        />

        <meta
          name="keywords"
          content="SEO image optimization, image SEO guide, optimize images for SEO, compress images for website, WEBP SEO, CompressIts blog"
        />

        <meta
          property="og:title"
          content="SEO Image Optimization Guide | CompressIts Blog"
        />

        <meta
          property="og:description"
          content="Learn how optimized images improve page speed, Google rankings, Core Web Vitals, and overall website performance."
        />
        ...
        <meta
          property="og:url"
          content="https://compressits.com/blog/seo-image-optimization"
        />

        <link
          rel="canonical"
          href="https://compressits.com/blog/seo-image-optimization"
        />
      </Helmet>
